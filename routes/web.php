...
})->middleware(['auth'])->name('add.staff');

Route::post('/insert-staff',[StaffController::class,'store'])->middleware(['auth']);

Route::get('/all-staff',[StaffController::class,'staffData'])->middleware(['auth'])->name('all.staffs');
...
Route::get('/create', [LocationController::class, 'createForm']);
